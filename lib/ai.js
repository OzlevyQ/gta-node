...
async function generateWithGemini(prompt, model, options = {}) {
  try {
    ...
    throw new Error('Gemini CLI not installed. Install: npm install -g @google/generative-ai-cli');
  }
...
export async function generateCommitMessage() {
  ...
  const prompt = `Generate a concise git commit message for these changes. Follow conventional commits format (type(scope): description).
